...
$name=$_POST['name'];
$sql=mysqli_query($link, "SELECT * FROM `users` WHERE `name`='".mysqli_real_escape_string($link, $name)."'");
...
<button class="knopka"> <a href="../client_table/table.php"><?php echo lang::trans('List');?></a>
    </body>
    </html></body></html>